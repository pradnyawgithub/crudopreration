...
const EmpEdit =()=> {
    ...
    useEffect(()=>{
        fetch("http://localhost:8000/dataemployee/"+empid).then((res)=>{
          return res.json();
        }).then((resp)=>{
            idchange(resp.id);
            fnamechange(resp.fname);
            lnamechange(resp.lname);
    ...
    const handlesubmit=(e)=>{
     e.preventDefault();
     const empdata={id,fname,lname,email,edit};

    fetch(" http://localhost:8000/dataemployee/"+empid,{
        method:"PUT",
                            ...
                            <div className="row">
                                ...
                                <div className="col-1g-12">
                                    <div className="form-check">
                                        <input value={edit} onChange={e=>editchange(e.target.value)} type="checkbox" className="form-check-input"></input>
